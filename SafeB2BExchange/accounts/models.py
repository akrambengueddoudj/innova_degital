...
class DocumentAuditLog(models.Model):
    ...
    document = models.ForeignKey('SecureDocument', on_delete=models.CASCADE, related_name='audit_logs')
...
class Report(models.Model):
    ISSUE_CHOICES = [
        ('document_error', 'Document content error'),
    ...
    def __str__(self):
        return f"{self.user.email} - {self.issue_type} - {self.created_at.strftime('%Y-%m-%d %H:%M')}"
